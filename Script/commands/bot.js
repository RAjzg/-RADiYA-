...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "Tmr Nam Ki") || (event.body.toLowerCase() == "তোমার নাম কি")) {
     return api.sendMessage("ZN JHUMA 🥹:))", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Zuma") || (event.body.toLowerCase() == "Jhuma")) {
     return api.sendMessage("আমি 𝐙𝐍 𝐉𝐇𝐔𝐌𝐀 আপনাকে কি ভাবে সাহায্য করতে পারি", threadID);
   };
  
   if ((event.body.toLowerCase() == "ওই কিরে") || (event.body.toLowerCase() == "oii Kire") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("𝐆𝐎𝐎𝐃 𝐌𝐎𝐑𝐍𝐈𝐍𝐆😚", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Nurnobi") || (event.body.toLowerCase() == "নুরনবী") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("নুরনবী আমার বস উনি এখন ডিউটিতে আছে..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "Owner") || (event.body.toLowerCase() == "Creator")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐌𝐃:➪ 𝐍𝐔𝐑𝐍𝐎𝐁𝐈 𝐇𝐀𝐐𝐔𝐄☜\𝐍 𝐘𝐎𝐔 𝐂𝐀𝐍 𝐂𝐀𝐋𝐋 𝐇𝐈𝐌 .\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :➪https://m.me/RAJA.ViP.5X.01715559179 \nতার সাতে যোগা যোগ করবেন 𝐖𝐇𝐀𝐓𝐀𝐏𝐏𝐒 :- 09638027946", threadID);
   };

   if ((event.body.toLowerCase() == "Tor Boss KE") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: 𝐌𝐃:➪ 𝐍𝐔𝐑𝐍𝐎𝐁𝐈 𝐇𝐀𝐐𝐔𝐄❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 𝐌𝐃:➪𝐍𝐔𝐑𝐍𝐎𝐁𝐈 𝐇𝐀𝐐𝐔𝐄 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ullash ッ❤️ তাকে সবাই 𝐌𝐃: 𝐍𝐔𝐑𝐍𝐎𝐁𝐈 𝐇𝐀𝐐𝐔𝐄 নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "ai") || (event.body.toLowerCase() == "Ai")) {
     return api.sendMessage(" 𝐈𝐅 𝐘𝐎𝐔 𝐖𝐀𝐍𝐓 𝐓𝐎 𝐔𝐒𝐄 𝐓𝐇𝐄 𝐀𝐈 𝐂𝐎𝐌𝐌𝐀𝐍𝐓 ,𝐓𝐘𝐏𝐄 /𝐀𝐈  ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "𝐙𝐔𝐌𝐀") || (event.body.toLowerCase() == "𝐉𝐇𝐔𝐌𝐀 ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস 𝐌𝐃:➪ 𝐍𝐔𝐑𝐍𝐎𝐁𝐈 𝐇𝐀𝐐𝐔𝐄 এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "ZUMA") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস উল্লাস'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "Kiss Me") || (event.body.toLowerCase() == "Kiss")) {
   ...
   if ((event.body.toLowerCase() == " Tmr Name Ki ") || (event.body.toLowerCase() == "Tomar nam ki ") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS 𝐙𝐍 𝐉𝐇𝐔𝐌𝐀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "𝐀𝐦𝐚𝐤𝐞 𝐊𝐞𝐰 𝐕𝐚𝐥𝐨𝐛𝐚𝐬𝐞 𝐍𝐚") || (event.body.toLowerCase() == "আমাকে কেউ ভালোবাসে না") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমি তো আছি 𝐙𝐍 𝐉𝐇𝐔𝐌𝐀🫶/nতোমাকে রাইতে ভালোবাসবো", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে  ইনবক্সে চলে যা 🌚🐸🌶️🍆", threadID);
   };
  ...
  if (event.body.indexOf("/Zuma") == 0 || (event.body.indexOf("/Jhuma") == 0)) {
    var msg = {
      body: `${name}, ${rand}`
    }
